    ...
    let pagHTML = `
      <html>
          ...
          <body>
              ...
              <div class="w3-container w3-teal" style="clear: both">
                  <h2 style="float: left">File List</h2>
                  <h3 style="float: right"><a href="/files/upload/">Upload Files</a></h3>
              </div>
...
function fileForm(d) {
    ...
    <html>
        ...
        <body>
            ...
            <div class="w3-container w3-teal" style="clear: both">
                <h2 style="float: left">File Upload</h2>
                <h3 style="float: right"><a href="/">Back</a></h3>
            </div>
            <div class="w3-container w3-sand">
                ...
                <button class="w3-btn w3-blue-grey" onclick="addfile()">Adicionar mais um ficheiro</button>
            </div>
    ...
    <body>
        <div class="w3-card-4">
            ...
            <div class="w3-container">
                <p><a href="/alunos/${aluno.id}">Aceda aqui a sua pagina."</a></p>
            </div>
            <footer class="w3-container w3-teal">
